...
$.run(async () => {
  ...
  // await cMysql.io.schema.dropTableIfExists('mark_pack_group')
  // await cMysql.io.schema.createTableIfNotExists('mark_pack_group', table => {
  //   table.comment('码压缩包组')
  //   table.charset('utf8mb4')
  //   table.collate('utf8mb4_unicode_ci')
  //   table.increments().comment('自增长ID、主键').notNullable().defaultTo(0)
  //   table.string('packGroupId', 32).comment('组ID').notNullable().defaultTo('')
  //   table.json('packIds').comment('包IDS').notNullable()
  //   table.integer('totalCount').comment('全部数量').notNullable().defaultTo(0)
  //   table.integer('pendedCount').comment('进行中数量').notNullable().defaultTo(0)
  //   table.integer('completedCount').comment('完成数量').notNullable().defaultTo(0)
  //   table.integer('status').comment('状态，1正常 2隐藏').notNullable().defaultTo(1)
  //   table.bigInteger('created').comment('创建时间').notNullable().defaultTo(0)
  //   table.bigInteger('updated').comment('更新时间').notNullable().defaultTo(0)
  //   table.unique(['packGroupId'])
  // })
  // await mysql2code.generate('files', 'MarkPackGroup', '码压缩包组')

  // await cMysql.io.schema.dropTableIfExists('mark_request_trace')
  // await cMysql.io.schema.createTableIfNotExists('mark_request_trace', table => {
  //   table.comment('公共系统请求记录')
  //   table.charset('utf8mb4')
  //   table.collate('utf8mb4_unicode_ci')
  //   table.increments().comment('自增长ID、主键').notNullable().defaultTo(0)
  //   table.string('traceId', 32).comment('请求ID').notNullable().defaultTo('')
  //   table.string('accountId', 32).comment('账户ID').notNullable().defaultTo('')
  //   table.string('operatorId', 32).comment('操作人').notNullable().defaultTo('')
  //   table.string('origin', 32).comment('来源').notNullable().defaultTo('')
  //   table.string('method', 32).comment('请求方式').notNullable().defaultTo('')
  //   table.string('fromIp', 32).comment('来源').notNullable().defaultTo('')
  //   table.json('request').comment('请求数据').notNullable()
  //   table.json('response').comment('请求参数').notNullable()
  //   table.bigInteger('created').comment('创建时间').notNullable().defaultTo(0)
  //   table.bigInteger('updated').comment('更新时间').notNullable().defaultTo(0)
  //   table.unique(['traceId'])
  // })
  // await mysql2code.generate('files', 'MarkRequestTrace', '公共系统请求记录表')

  // await cMysql.io.schema.dropTableIfExists('shop_advert')
  // await cMysql.io.schema.createTableIfNotExists('shop_advert', table => {
  //   table.comment('商城系统广告')
  //   table.charset('utf8mb4')
  //   table.collate('utf8mb4_unicode_ci')
  //   table.increments().comment('自增长ID、主键').notNullable().defaultTo(0)
  //   table.string('advertId', 32).comment('广告ID').notNullable().defaultTo('')
  //   table.string('accountId', 32).comment('账户ID').notNullable().defaultTo('')
  //   table.string('title', 64).comment('标题').notNullable().defaultTo('')
  //   table.string('cover', 256).comment('封面图片').notNullable().defaultTo('')
  //   table.string('icon', 256).comment('悬浮图片').notNullable().defaultTo('')
  //   table.string('type', 256).comment('类型，none 不跳转 wxa 当前小程序 other-wxa其他小程序 http自定义链接').notNullable().defaultTo('')
  //   table.string('uri', 64).comment('通用链接').notNullable().defaultTo('')
  //   table.bigInteger('startAt').comment('广告位展示开始时间').notNullable().defaultTo(0)
  //   table.bigInteger('endAt').comment('广告位展示结束时间').notNullable().defaultTo(0)
  //   table.bigInteger('weight').comment('权重，用于排序').notNullable().defaultTo(0)
  //   table.bigInteger('created').comment('创建时间').notNullable().defaultTo(0)
  //   table.bigInteger('updated').comment('更新时间').notNullable().defaultTo(0)
  //   table.unique(['advertId'])
  // })
  // await mysql2code.generate('files', 'ShopAdvert', '商城系统广告')

  // await cMysql.io.schema.dropTableIfExists('shop_spu_group')
  // await cMysql.io.schema.createTableIfNotExists('shop_spu_group', table => {
  //   table.comment('商城商品分组')
  //   table.charset('utf8mb4')
  //   table.collate('utf8mb4_unicode_ci')
  //   table.increments().comment('自增长ID、主键').notNullable().defaultTo(0)
  //   table.string('spuGroupId', 32).comment('商品分组ID').notNullable().defaultTo('')
  //   table.string('accountId', 32).comment('账户ID').notNullable().defaultTo('')
  //   table.string('name', 64).comment('分组名称').notNullable().defaultTo('')
  //   table.integer('weight').comment('权重').notNullable().defaultTo(0)
  //   table.string('visible', 32).comment('显示状态，visible显示invisible不显示').notNullable().defaultTo('')
  //   table.string('icon', 256).comment('分组图标').notNullable().defaultTo('')
  //   table.string('cover', 256).comment('分组封面').notNullable().defaultTo('')
  //   table.integer('status').comment('状态，1正常 2隐藏').notNullable().defaultTo(1)
  //   table.bigInteger('created').comment('创建时间').notNullable().defaultTo(0)
  //   table.bigInteger('updated').comment('更新时间').notNullable().defaultTo(0)
  //   table.unique(['spuGroupId'])
  // })
  // await mysql2code.generate('files', 'ShopSpuGroup', '商城商品分组')
  //
  // await cMysql.io.schema.dropTableIfExists('shop_category')
  // await cMysql.io.schema.createTableIfNotExists('shop_category', table => {
  //   table.comment('商城商品分组')
  //   table.charset('utf8mb4')
  //   table.collate('utf8mb4_unicode_ci')
  //   table.increments().comment('自增长ID、主键').notNullable().defaultTo(0)
  //   table.string('categoryId', 32).comment('商品类目ID').notNullable().defaultTo('')
  //   table.string('parentCategoryId', 32).comment('父商品类目ID').notNullable().defaultTo('')
  //   table.string('accountId', 32).comment('账户ID').notNullable().defaultTo('')
  //   table.string('name', 64).comment('类目名称').notNullable().defaultTo('')
  //   table.integer('weight').comment('权重').notNullable().defaultTo(0)
  //   table.string('visible', 32).comment('显示状态，visible显示invisible不显示').notNullable().defaultTo('')
  //   table.string('icon', 256).comment('类目图标').notNullable().defaultTo('')
  //   table.string('cover', 256).comment('类目封面').notNullable().defaultTo('')
  //   table.integer('status').comment('状态，1正常 2隐藏').notNullable().defaultTo(1)
  //   table.bigInteger('created').comment('创建时间').notNullable().defaultTo(0)
  //   table.bigInteger('updated').comment('更新时间').notNullable().defaultTo(0)
  //   table.unique(['categoryId'])
  // })
  // await mysql2code.generate('files', 'ShopCategory', '商城商品类目')
